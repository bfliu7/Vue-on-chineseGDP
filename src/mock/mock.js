...
//     timeout:20000,
//     baseURL:'124.71.207.74:5000/test_api'
//   })
//延时200-600毫秒请求到数据
Mock.setup({
    timeout: '200-600'
...
function countDeviceNum() {
    const a = Mock.mock({
        success: true,
        data: {
            alarmNum: '@integer(1, 10)',
            offlineNum: '@integer(1, 10)',
            totalNum: '@integer(1, 10)'
        }
    })
...
Mock.mock(new RegExp('cD_bottom'), 'get', cD_bottom)
...
function alarmNum() {
    const a = Mock.mock({
        success: true,
        data: {
            dateList: ['2021-11', '2021-12', '2022-01', '2022-02', '2022-03'],
            "numList|6": [
                '@integer(0, 1000)'
            ],
            "numList2|6": [
